...
public class MrPoll implements EntryPoint {
	...
	public static enum State {
		USER_LOGIN, MAIN_MENU, USER_UPDATE, NEW_USER, NEW_PATIENT, USER_SEARCH, VISIT_SEARCH, USER_TO_UPDATE, TAB_PATIENT_INFO, TAB_VISIT, TAB_CLINIC, TAB_MAMMOGRAPHY, TAB_USG, TAB_MRI, TAB_PATHOLOGY, TAB_SECOND, TAB_SURGICAL
	}
	...
	public static void setEditVisitData(EditVisitData editVisitData) {
		...
		if (editVisitData == null) {
			...
			userService.getSessionUser("loginUser",
					new AsyncCallback<UserUI>() {
	...
	public static void updateUi(AbsolutePanel panel, List<AnswerUI> answers) {
