...
public class TabMammography extends Composite {
	...
	@UiField
	ListBox r_microcalcificationtype;
	@UiField
	ListBox l_microcalcificationtype;
	@UiField
	CheckBox r_microcalcification;
	@UiField
	TextBox r_microcalcificationarea;
	@UiField
	CheckBox l_microcalcification;
	@UiField
	TextBox l_microcalcificationarea;
	@UiField
	Label r_microcalcificationarea_label;
	@UiField
	Label r_microcalcificationtype_label;
	@UiField
	Label r_microcalcificationarea_label_;
	@UiField
	Label l_microcalcificationarea_label;
	@UiField
	Label l_microcalcificationtype_label;
	@UiField
	Label l_microcalcificationarea_label_;
	...
	void onR_nofindingClick(ClickEvent event) {
		...
		r_axillary.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		r_microcalcification.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		r_nonmass.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		onR_massClick(null);
	...
	void onL_nofindingClick(ClickEvent event) {
		...
		l_axillary.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		l_microcalcification.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		l_nonmass.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		onL_massClick(null);
	...
	void onR_microcalcificationClick(ClickEvent event) {
		Boolean lockStatus = r_microcalcification.getValue()
				&& r_microcalcification.isEnabled();
		r_microcalcificationarea.setEnabled(lockStatus);
		r_microcalcificationtype.setEnabled(lockStatus);
		r_microcalcificationarea_label.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		r_microcalcificationtype_label.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		r_microcalcificationarea_label_.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
	}

	@UiHandler("l_microcalcification")
	void onL_microcalcificationClick(ClickEvent event) {
		Boolean lockStatus = l_microcalcification.getValue()
				&& l_microcalcification.isEnabled();
		l_microcalcificationarea.setEnabled(lockStatus);
		l_microcalcificationtype.setEnabled(lockStatus);
		l_microcalcificationarea_label.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		l_microcalcificationtype_label.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
		l_microcalcificationarea_label_.getElement().getStyle()
				.setColor(!lockStatus ? "#A8A8A8" : "black");
	}
